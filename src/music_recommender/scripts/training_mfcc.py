...
if os.path.exists(cfg.paths.models / "MFCC_model_comparison_results.csv"):
    logger.info(
        f"Found models training results in {cfg.paths.models / 'MFCC_model_comparison_results.csv'} skipping the retrainig for now"
    )
